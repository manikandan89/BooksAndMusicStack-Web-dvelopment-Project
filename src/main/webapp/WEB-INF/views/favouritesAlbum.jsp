    ...
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&amp;callback=initializeMap"></script>
         ...
         <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/angular.js"></script>
           <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/favouritesAlbum.js"></script>
...
<div class="section secondary-section ">
    ...
    <div class="container">
    	...
    	<div class="row" style="margin-left: 5px">
		  ...
		  <div class="large-4 columns">
		  	...
		  	<select onChange="window.location.href=this.value">
			    <option value="<%=request.getContextPath()%>/user/profile/favourites/album">Albums</option>
			    <option value="<%=request.getContextPath()%>/user/profile/favourites/track">Tracks</option>
			</select>
        ...
        <div class="container" ng-controller="favAlbumController">
