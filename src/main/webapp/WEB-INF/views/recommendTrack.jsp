...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&amp;callback=initializeMap"></script>
         ...
         <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/ui-bootstrap-tpls-0.12.1.js"></script>
           <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/trackRecommendation.js"></script>
          <style>
    ...
    <body ng-app="ui.bootstrap.TrackRecommendation">
        <div class="navbar">
 ...
 <p id="hiddenelement" value="${trackId}" hidden></p>
...
<div class="section secondary-section " id="portfolio">
    ...
    <div class="container">
    	...
    	<div class='container-fluid' ng-controller="TrackRecommendationController">
           ...
           <input type="text" ng-model="asyncSelected.userId" placeholder="Search friends" typeahead="address.label for address in getLocation($viewValue)" typeahead-loading="loadingLocations" class="form-control">
            ...
            <form>
           <button ng-click="recommendTrack(asyncSelected)" class="btn btn-primary">Recommend track</button>
           </form>
