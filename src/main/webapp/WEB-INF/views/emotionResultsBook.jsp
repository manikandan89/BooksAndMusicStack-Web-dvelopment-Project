    ...
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&amp;callback=initializeMap"></script>
         ...
         <%-- <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/ui-bootstrap-tpls-0.12.1.js"></script> --%>
           ...
           <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/emotionResultsBook.js"></script>
...
<div class="section secondary-section " id="portfolio">
    ...
    <div class="container" ng-controller="EmotionBookController">
   ...
   <div class="large-8 columns"><h4>Your current emotional state is <b>${emotion}</b></h4></div>
    ...
    <div class="row" style="margin-left: 5px">
      ...
      <div class="container">
  			...
  			<li ng-repeat="book in books" class="span4 mix identity">
                        <div class="thumbnail">
                            <img src="{{ book.bestBook.largeImage }}">
                            <a href="<%=request.getContextPath()%>/user/book/{{ book.bestBook.id }}" class="show_hide more">
                                <i class="icon-plus"></i>
                            </a>
                            <h3>{{ book.bestBook.title }}</h3>
