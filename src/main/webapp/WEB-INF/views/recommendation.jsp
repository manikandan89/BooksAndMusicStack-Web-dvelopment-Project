...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&amp;callback=initializeMap"></script>
         ...
         <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/angular.js"></script>
           <script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/js/recommendation.js"></script>
    ...
    <body ng-app="viewRecommendationApp">
        <div class="navbar">
...
<div class="section secondary-section " id="portfolio">
    ...
    <div class="container">
    	...
    	<div ng-controller="ViewRecommendationController" class="container"> 
			<table class="table">
			  <tbody>
			  	<tr>
			  		<th><h3>Track</h3></th>
			    ...
			    <tr ng-repeat="trackRecommendationModel in trackRecommendationModels" >
			      <td><a href="{{trackRecommendationModel.track.previewUrl}}" ><u><font color="blue">{{trackRecommendationModel.track.name}}</font></u></a></td>
			      <td><i><font color="blue">{{trackRecommendationModel.recommendedBy}}</font></i></td>
			    </tr>  
			  </tbody>
			</table>
		</div>
