...
public class JsonUtil {
  ...
  public static Page<Album> createAlbumPage(JSONObject albumPageJson) {
    Page<Album> page = createItemlessPage(albumPageJson.getJSONObject("albums"));
  ...
  public static Page<Track> createTrackPage(JSONObject trackPageJson) {
    Page<Track> page = createItemlessPage(trackPageJson.getJSONObject("tracks"));
  ...
  public static Page<Artist> createArtistPage(JSONObject artistPageJson) {
    Page<Artist> page = createItemlessPage(artistPageJson);
  ...
  public static Page<SimpleTrack> createSimpleTrackPage(JSONObject simpleTrackPageJson) {
    Page<SimpleTrack> page = createItemlessPage(simpleTrackPageJson);
  ...
  public static Page<SimpleAlbum> createSimpleAlbumPage(JSONObject simpleAlbumPageJson) {
    Page<SimpleAlbum> page = createItemlessPage(simpleAlbumPageJson);
